...
public class Song implements org.apache.thrift.TBase<Song, Song._Fields>, java.io.Serializable, Cloneable, Comparable<Song> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> singer; // required
  ...
  public Song(
    ...
    java.util.List<java.lang.String> singer)
  {
    this();
    this.id = id;
    setIdIsSet(true);
  ...
  public Song(Song other) {
    ...
    if (other.isSetSinger()) {
      java.util.List<java.lang.String> __this__singer = new java.util.ArrayList<java.lang.String>(other.singer);
  ...
  public Song setTitle(@org.apache.thrift.annotation.Nullable java.lang.String title) {
    this.title = title;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getSingerIterator() {
    return (this.singer == null) ? null : this.singer.iterator();
  }

  public void addToSinger(java.lang.String elem) {
    if (this.singer == null) {
      this.singer = new java.util.ArrayList<java.lang.String>();
    }
    this.singer.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.String> getSinger() {
    return this.singer;
  }

  public Song setSinger(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> singer) {
    this.singer = singer;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SINGER:
      if (value == null) {
        ...
        setSinger((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int compareTo(Song other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSinger(), other.isSetSinger());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSinger()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.singer = new java.util.ArrayList<java.lang.String>(_list0.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Song struct) throws org.apache.thrift.TException {
      ...
      if (struct.singer != null) {
        oprot.writeFieldBegin(SINGER_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter3 : struct.singer)
          {
      ...
      if (struct.isSetSinger()) {
        {
          ...
          for (java.lang.String _iter4 : struct.singer)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.singer = new java.util.ArrayList<java.lang.String>(_list5.size);
